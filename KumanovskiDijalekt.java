...
public class KumanovskiDijalekt {
    public static void main (String[] args) throws IOException {
        ...
        CBHT<String,String> table = new CBHT<>(997);
        ...
        String[] tekstDelovi = tekst.split(" ");

        //Vasiot kod tuka

        for (int i=0; i<tekstDelovi.length; i++){
            String word = tekstDelovi[i];
        ...
        System.out.print(tekstDelovi[0]);
        for (int i=1; i<tekstDelovi.length; i++){
            System.out.print(" " + tekstDelovi[i]);
        }
    }
}
